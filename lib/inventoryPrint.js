...
<body>
  <header>
    <div><h1>Vertice - ${title}</h1><p>${isCountSheet ? "Fiziksel sayımı son sütuna elle yazınız." : "Depo ve bar stoklarının güncel toplam görünümü."}</p></div>
  ...
  <footer><span>Stockera Stok Yönetimi</span><span>Sayfa numarası yazdırma ayarlarından eklenebilir.</span></footer>
